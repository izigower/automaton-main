...
export function loadConfig(): AutomatonConfig | null {
  ...
  try {
    ...
    if (!merged.conwayApiUrl && !merged.ollamaBaseUrl) {
      throw new Error('Need either conwayApiUrl or ollamaBaseUrl');
    }
...
export function createConfig(params: {
  ...
  conwayApiUrl?: string; // added conwayApiUrl optional to enable empty URL via setup
  ...
  return {
    ...
    conwayApiUrl: params.conwayApiUrl,
